"""
Stable Diffusion 2.5 + ControlNet Fine-tuning for Style Transfer
...
Note: SD2.5 uses 768x768 resolution and different architecture than SD1.5
"""
...
# ==================== CONFIGURATION ====================
PROJECT_NAME = "style-transfer-sd25-controlnet"
RUN_NAME = "sd25-controlnet-60k-20epochs"
...
OUTPUT_DIR = "/home/msai/birul001/BIRUL001/models/sd25_controlnet"

# Hyperparameters
NUM_EPOCHS = 20
BATCH_SIZE = 2  # SD2.5 uses 768x768, needs more memory
...
print(f"{'='*80}")
print(f"Stable Diffusion 2.5 + ControlNet Fine-tuning")
print(f"{'='*80}")
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            return {
                ...
                "target_image": synthetic_img,  # Target output
            ...
            return {
                "caption": caption,
                "content_image": torch.zeros(3, 768, 768),
                "target_image": torch.zeros(3, 768, 768),
                "content_path": content_path,
                "synthetic_path": synthetic_path
            }
...
def setup_model_and_optimizer():
    """Initialize SD2.5 UNet with LoRA + ControlNet"""
    
    print(f"\n{'='*80}")
    print("Loading Stable Diffusion v2.5 + ControlNet...")
    print(f"{'='*80}")
    
    # Initialize ControlNet from SD2.5 UNet
    ...
    # Load base SD2.5 pipeline
    # Note: SD2.5 is often referred to as SD2.1 in model repos
