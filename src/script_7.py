...
with open('train_hcscdnet.py', 'w') as f:
    f.write(training_code)

print("✅ Training Pipeline saved to train_hcscdnet.py")
print("   - 3-phase training strategy (following 2-week plan)")
print("   - Phase 1: β-VAE disentanglement learning")
print("   - Phase 2: Hybrid integration training")  
print("   - Phase 3: End-to-end fine-tuning")
print("   - Separate optimizers for different components")
