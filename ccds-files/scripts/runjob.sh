...
#SBATCH --time=02:00:00               # Max job time = 2 hours
#SBATCH --job-name=GAN-Infer        # Job name
#SBATCH --output=/home/msai/birul001/gan-project/gan-HC-SCDNet/ccds-files/logs/output_%x_%j.out   # Std output log
#SBATCH --error=/home/msai/birul001/gan-project/gan-HC-SCDNet/ccds-files/logs/error_%x_%j.err     # Std error log
...
# -----------------------------
PYTHON_SCRIPT="/home/msai/birul001/gan-project/gan-HC-SCDNet/existing-pretrained/test_real_images.py"  # <-- your Python script path
CONTENT_PATH="/home/msai/birul001/gan-project/gan-HC-SCDNet/existing-pretrained/content-3.png"
STYLE_PATH="/home/msai/birul001/gan-project/gan-HC-SCDNet/existing-pretrained/style2.png"
...
OUTPUT_TXT="${CCDS_DIR}/py-output/output_${RUN_TS}_${JOB_ID}.txt"
{
  echo "==== GAN Inference Run ===="
  echo "Started: $(date)"
  echo "Job Name: ${SLURM_JOB_NAME:-GAN-Infer}"
  echo "Job ID: ${SLURM_JOB_ID:-N/A}"
  echo "Node: $(hostname)"
  echo "GPU(s) requested: ${SLURM_GPUS:-1}"
  echo "Script: $PYTHON_SCRIPT"
  echo "Content Image: $CONTENT_PATH"
  echo "Style Image: $STYLE_PATH"
...
if [ -f "$PYTHON_SCRIPT" ]; then
    echo "Executing: python $PYTHON_SCRIPT --content $CONTENT_PATH --style $STYLE_PATH" >> "$OUTPUT_TXT"
    python "$PYTHON_SCRIPT" --content "$CONTENT_PATH" --style "$STYLE_PATH" >> "$OUTPUT_TXT" 2>&1
else
