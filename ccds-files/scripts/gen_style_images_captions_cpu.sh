...
#SBATCH --cpus-per-task=8                # Request 6 CPU cores
...
#SBATCH --output=/home/msai/birul001/gan-project/gan-HC-SCDNet/ccds-files/logs/others/output_cpu_%x_%j.out   # Std output log
#SBATCH --error=/home/msai/birul001/gan-project/gan-HC-SCDNet/ccds-files/logs/others/error_cpu_%x_%j.err     # Std error log
...
# -----------------------------
PYTHON_SCRIPT="/home/msai/birul001/gan-project/gan-HC-SCDNet/vlm-caption/gen_caption_llama.py"  # <-- your Python script path
...
OUTPUT_TXT="${CCDS_DIR}/py-output/generate_caption_cpu_${RUN_TS}_${JOB_ID}.txt"
{
