...
#SBATCH --job-name=vae_infer          # Job name
#SBATCH --output=/home/msai/birul001/gan-project/gan-HC-SCDNet/ccds-files/logs/infer/output_%x_%j.out   # Std output log
#SBATCH --error=/home/msai/birul001/gan-project/gan-HC-SCDNet/ccds-files/logs/infer/error_%x_%j.err     # Std error log
...
PYTHON_SCRIPT="/home/msai/birul001/gan-project/gan-HC-SCDNet/b-vae/train/inference.py"  # <-- your Python script path
...
OUTPUT_TXT="${CCDS_DIR}/infer_output/output_${RUN_TS}_${JOB_ID}.txt"
{
  echo "==== VAE Inference Run ===="
  echo "Started: $(date)"
  echo "Job Name: ${SLURM_JOB_NAME:-VAE-Inference}"
